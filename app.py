...
def expenses():
    ...
    return render_template('expenses.html',expenses=expenses, total=total, t_business=t_business, t_food=t_food, t_other=t_other, t_entertainment=t_entertainment)
